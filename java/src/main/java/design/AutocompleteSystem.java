...
public class AutocompleteSystem {
        ...
        if (c == '#') {
            ...
            if (curr != null) {
                if (curr.containsChild(c)) {
                    ...
                    curr = null;  // as soon as we encounter a empty node then set current to null indicating no
                                  // further
    ...
    private class Trie {
        ...
        private TreeSet<HotText> hotText = new TreeSet<>((HotText o1, HotText o2) -> {
        ...
        private HotText update(int i, String word, int length) {
            if (i < length) {
                ...
                HotText currHotText =
                    new HotText(c + (subTrieHotText == null ? "" : subTrieHotText.getText()), hotTextMap.get(word));
