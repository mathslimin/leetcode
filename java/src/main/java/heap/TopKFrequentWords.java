...
/**
 * Created  on 07/04/2018. Given a non-empty list of words, return the k most
 * frequent elements.
 *
...
public class TopKFrequentWords {
    ...
    public List<String> topKFrequent(String[] words, int k) {
        ...
        Queue<Pair> pq = new PriorityQueue<>(
            (o1, o2) -> (o1.freq == o2.freq) ? o2.word.compareTo(o1.word) : Integer.compare(o1.freq, o2.freq));
