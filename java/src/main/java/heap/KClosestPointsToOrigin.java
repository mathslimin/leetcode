...
/**
 * Created  on 30/11/2019 We have a list of points on the plane. Find the K
...
public class KClosestPointsToOrigin {
    ...
    public int[][] kClosest(int[][] points, int K) {
        PriorityQueue<Point> pq = new PriorityQueue<>((o1, o2) -> Long.compare(o2.distance(), o1.distance()));
        for (int[] p : points) {
