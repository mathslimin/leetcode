...
/**
 * Created  on 23/01/2018. You have k lists of sorted integers in ascending
...
public class SmallestRange {
    ...
    public int[] smallestRange(List<List<Integer>> nums) {
        PriorityQueue<MinIndex> pq =
            new PriorityQueue<>((o1, o2) -> Integer.compare(nums.get(o1.i).get(o1.j), nums.get(o2.i).get(o2.j)));
