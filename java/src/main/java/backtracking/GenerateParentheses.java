...
/**
 * Created  on 24/06/2017. Given n pairs of parentheses, write a function to
...
public class GenerateParentheses {
    ...
    private void backTrack(List<String> list, String str, int open, int close, int n) {
        if (str.length() == n * 2) {
            ...
            if (close < open)  // number of close should be less than open or else it can result in unbalanced
                               // parentheses
