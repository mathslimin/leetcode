...
/**
 * Created  on 15/12/2017. Given a set of non-overlapping intervals, insert a
    ...
    public List<Interval> insert(List<Interval> intervals, Interval newInterval) {
        ...
        for (int i = 0, l = intervals.size(); i < l; i++) {
            ...
            if (newInterval.start >= curr.start && newInterval.end <= curr.end) {
                ...
                // merge and continue
            } else if (newInterval.start >= curr.start && newInterval.start <= curr.end && newInterval.end > curr.end) {
                newInterval = new Interval(curr.start, newInterval.end);
                // merge and continue
            } else if (newInterval.start < curr.start && newInterval.end >= curr.start && newInterval.end <= curr.end) {
