...
/**
 * Created  on 10/04/2021 Given a string S, find the number of different
...
public class CountDifferentPalindromicSubsequences {
    public static void main(String[] args) {
        System.out.println(new CountDifferentPalindromicSubsequences().countPalindromicSubsequences(
