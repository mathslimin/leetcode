...
/**
 * Created  on 04/06/2019 Given a non-empty string containing an out-of-order
...
public class ReconstructOriginalDigitsFromEnglish {
    public static void main(String[] args) {
        System.out.println(new ReconstructOriginalDigitsFromEnglish().originalDigits(
    ...
    private void update(
        Map<Character, Integer> map, Map<Integer, Integer> intMap, int num, char id, List<Character> list) {
