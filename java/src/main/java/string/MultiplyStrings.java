...
/**
 * Created  on 01/02/2018. Given two non-negative integers num1 and num2
    ...
    public String multiply(String num1, String num2) {
        ...
        for (int i = num1.length() - 1; i >= 0; i--) {
            ...
            for (int j = num2.length() - 1; j >= 0; j--) {
                int prod =
                    Integer.parseInt(String.valueOf(num2.charAt(j))) * Integer.parseInt(String.valueOf(num1.charAt(i)));
                prod += carry;
                temp1 = (prod % 10) + temp1;
                carry = (prod / 10);
            }
