...
/**
 * Created  on 21/04/2018. Given an integer n, find the closest integer (not
        ...
        if (isPaliandrome(n)) {
            ...
            if (n.length() % 2 == 0) {
                ...
                if (middle == '0') {
                    ...
                    p1 = firstHalf + (Integer.parseInt(String.valueOf(middle)) - 1) +
            ...
            if (n.length() % 2 == 0) {
                ...
                p1 =
                    Math.abs(Long.parseLong(p3) - Long.parseLong(n)) <= Math.abs(Long.parseLong(p1) - Long.parseLong(n))
                    ? p3
                    : p1;
            } else {
                char middle = n.charAt(n.length() / 2);
                ...
                String p3 =
                    firstHalf + (Integer.parseInt(String.valueOf(middle)) + 1) + new StringBuilder(firstHalf).reverse();
                String p4 = null;
                if (middle != '0') {
                    p4 = firstHalf + (Integer.parseInt(String.valueOf(middle)) - 1) +
                        new StringBuilder(firstHalf).reverse();
                }
                p1 =
                    Math.abs(Long.parseLong(p1) - Long.parseLong(n)) <= Math.abs(Long.parseLong(p3) - Long.parseLong(n))
                    ? p1
                    : p3;
                if (p4 != null) {
                    p1 = Math.abs(Long.parseLong(p4) - Long.parseLong(n)) <=
